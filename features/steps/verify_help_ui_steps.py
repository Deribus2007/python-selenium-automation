...
def target_help_page_open(context):
...
def search_help_window(context):
...
def see_the_search_icon(context):
...
def see_box_text(context, box_text):
...
def see_link_text(context, link_text):
